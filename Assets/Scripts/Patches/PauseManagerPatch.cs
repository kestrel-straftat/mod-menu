...
namespace ModMenu.Patches
{
    ...
    internal static class PauseManagerPatch
    {
        ...
        public static readonly HashSet<BoxedValueController> currentlyRebindingKeybindContollers = new();

        // override menu input callback if any keycode/keyboardshortcut options are rebinding
        [HarmonyPatch("Menu")]
        [HarmonyPrefix]
        public static bool DoNotOpenIfRebinding() => currentlyRebindingKeybindContollers.Count == 0;
    }
}