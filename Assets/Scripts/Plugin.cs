...
namespace ModMenu
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        // NOTE: YOU DO NOT NEED THIS STUFF UNLESS YOU *NEED* CUSTOM CONFIG LIST ITEMS
        // ModMenu will autogenerate a config for you from your mod's BepInEx ConfigFile
        // the autogenerated config is probably good enough for 90% of mods.
